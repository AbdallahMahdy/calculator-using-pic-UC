...
{	
	...
	if (C4 == 0) { __delay_ms(250); while (C4==0); return 'C'; }
	...
	if (C4 == 0) { __delay_ms(250); while (C4==0); return 'B'; }
	...
	if (C4 == 0) { __delay_ms(250); while (C4==0); return 'A'; }
	...
	if (C4 == 0) { __delay_ms(250); while (C4==0); return 'D'; }
